...
class GameManager
{
  ...
  public:
    ...
    void SetMapRightEdge(float edge)
    {
        this->mapRightEdge = edge;
    }
    float GetMapRightEdge()
    {
        return mapRightEdge;
    }
    ...
    void SetGameWin(bool isGameWin)
    {
    ...
    void SetLevelClear(bool isLevelClear)
    {
    ...
    void SetLevelCleared(int lvl, bool cleared)
    {
        if (lvl >= 1 && lvl <= 5)
            clearedLevels[lvl] = cleared;
    }
    bool IsLevelCleared(int lvl)
    {
        if (lvl >= 1 && lvl <= 5)
            return clearedLevels[lvl];
        return false;
    }
    ...
    void SetMarioScissors(bool scissors)
    {
        isMarioScissors = scissors;
    }
    bool IsMarioScissors()
    {
        return isMarioScissors;
    }
