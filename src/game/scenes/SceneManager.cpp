        ...
        if (worldMapScene)
        {
            ...
            if (worldMapScene->IsDone())
            {
                ...
                if (levelToLoad > 0)
                {
                    ...
                    if (levelToLoad == 5)
                    {
                        Map::GetInstance()->LoadMap(L"assets/levels/level_5.txt");
                    }
                    else if (levelToLoad == 4)
                    {
                        Map::GetInstance()->LoadMap(L"assets/levels/level_4.txt");
                    }
                    else if (levelToLoad == 3)
                    {
                        Map::GetInstance()->LoadMap(L"assets/levels/level_3.txt");
                    }
                    else if (levelToLoad == 2)
                    {
                        Map::GetInstance()->LoadMap(L"assets/levels/level_2.txt");
                    }
                    else
                    {
                        Map::GetInstance()->LoadMap(L"assets/levels/level_1.txt");
                    }
...
void SceneManager::Render()
{
    ...
    else if (currentState == STATE_PLAYING)
    {
        ...
        else if (isMarioLevelClearing)
        {
            ...
            int cardSpriteId = 0;
            if (rouletteCardType == 1)
                cardSpriteId = 3018;
            else if (rouletteCardType == 2)
                cardSpriteId = 3019;
            else if (rouletteCardType == 3)
                cardSpriteId = 3020;
            else if (rouletteCardType == 4)
                cardSpriteId = 3021;
