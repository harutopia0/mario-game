...
void ResourceLoader::LoadAll()
{
    ...
    textures->Add(TEX_MARIO, L"assets/images/mario_luigi.png");
    textures->Add(TEX_COMMON1, L"assets/images/common_objects_1.png");
    textures->Add(TEX_COMMON2, L"assets/images/common_objects_2.png");
    textures->Add(TEX_FIRE_MARIO, L"assets/images/fire_mario.png");
    textures->Add(TEX_SCISSORS_MARIO, L"assets/images/scissor_mario.png");

    textures->Add(TEX_HUD, L"assets/images/hud.png");
    textures->Add(TEX_INTRO, L"assets/images/intro_items.png");
    textures->Add(TEX_BBOX, L"assets/images/bbox.png");
    textures->Add(TEX_ENEMY_TEST, L"assets/images/enemy.png");

    textures->Add(TEX_LEVEL_CLEAR, L"assets/images/level_clear.png");
    textures->Add(TEX_YOU_WIN, L"assets/images/you_win.png");
    textures->Add(TEX_GAME_OVER, L"assets/images/game_over.png");

    textures->Add(TEX_MAP_LEVEL, L"assets/images/map_level.png");

    textures->Add(TEX_OBTAIN_ITEM, L"assets/images/obtain_item.png");
    textures->Add(TEX_WHITE, L"assets/images/white.png");

    // Enemy sprite sheets
    textures->Add(TEX_ENEMIES_1, L"assets/images/enemies_transparent.png");
    textures->Add(TEX_ENEMIES_2, L"assets/images/enemies_transparent_3.png");

    // Brick

    // grass brick
    textures->Add(TEX_GRASS_BRICK, L"assets/images/tiles.png");
    textures->Add(TEX_CLOUDS, L"assets/images/clouds.png");
    ...
    ani->Add(30021);
    ani->Add(30022);
    animations->Add(5011, ani);
    ani = new Animation(150);
    ani->Add(30023);
    ani->Add(30024);
    animations->Add(5012, ani);
    ani = new Animation(150);
    ani->Add(30025);
    ani->Add(30026);
    animations->Add(5013, ani);
    ani = new Animation(150);
    ani->Add(30027);
    ani->Add(30028);
    animations->Add(5014, ani);
    ...
    ani = new Animation(100);
    ani->Add(1300);
    animations->Add(1300, ani); // Cloud 60px
    ani = new Animation(100);
    ani->Add(1301);
    animations->Add(1301, ani); // Cloud 75px
    ani = new Animation(100);
    ani->Add(1302);
    animations->Add(1302, ani); // Cloud 90px
    ani = new Animation(100);
    ani->Add(1303);
    animations->Add(1303, ani); // Cloud Block
    ...
    AudioManager::GetInstance()->LoadSound("mario_theme",
                                           "assets/audio/mario_theme.mp3");
    AudioManager::GetInstance()->LoadSound("level_theme",
                                           "assets/audio/level_theme.mp3");
    AudioManager::GetInstance()->LoadSound("power_up",
                                           "assets/audio/power_up.mp3");
    AudioManager::GetInstance()->LoadSound(
        "mushroom_sound_effect",
        "assets/audio/mushroom_obtain.mp3");
    AudioManager::GetInstance()->LoadSound("super_mario_pipe",
                                           "assets/audio/pipe_travel.mp3");
    AudioManager::GetInstance()->LoadSound("win_level",
                                           "assets/audio/level_complete.mp3");
    AudioManager::GetInstance()->LoadSound("use-failed", "assets/audio/use_failed.mp3");
    AudioManager::GetInstance()->LoadSound("fire-blast", "assets/audio/fire_blast.mp3");
    AudioManager::GetInstance()->LoadSound("rolling-ball",
                                           "assets/audio/rolling_ball.mp3");
    AudioManager::GetInstance()->LoadSound(
        "mario_die", "assets/audio/mario_death.mp3");
    AudioManager::GetInstance()->LoadSound("mario_jump", "assets/audio/jump.mp3");
    AudioManager::GetInstance()->LoadSound(
        "intro_theme", "assets/audio/opening_theme.mp3");
    AudioManager::GetInstance()->LoadSound(
        "star_theme", "assets/audio/star_theme.mp3");
    AudioManager::GetInstance()->LoadSound("slash-sound",
                                           "assets/audio/slash_sound.mp3");
    AudioManager::GetInstance()->LoadSound("parry-sound",
                                           "assets/audio/parry.mp3");
    AudioManager::GetInstance()->LoadSound("stomp", "assets/audio/stomp.wav");
    AudioManager::GetInstance()->LoadSound("kick", "assets/audio/kick.wav");
