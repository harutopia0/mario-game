...
class Koopa : public Enemy
{
  ...
  public:
    ...
    virtual bool CanFallOffLedge() override
    {
        return state != KOOPA_STATE_WALKING;
    }
    ...
    {
        return (state == KOOPA_STATE_SHELL || state == KOOPA_STATE_SHELL_SHAKING) && (GetTickCount64() - shellTimeStart < KOOPA_JUST_SHELLED_TIME);
    }
